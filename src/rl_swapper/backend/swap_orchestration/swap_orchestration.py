...
# def stem_matches_legacy(asset_package: str, file_name: str) -> bool:
#     left = Path(asset_package).name
#     right = Path(file_name).name
#     return left == right


# def next_run_index_legacy(runs_dir: Path) -> int:
#     run_index = 0
#     if runs_dir.exists():
...
# def push_swap_legacy(swap: SwapRecord, rl_source_dir: Path) -> SwapRecord:
